/* ============================================
   MALEK ABDELRAHMAN — Cipher Theme Scripts
   Universal behaviors + custom falling-glyph "code rain"
   light background · indigo/blue glyphs (non-green).
   ============================================ */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (canvas && !reduceMotion) {
        ...
        const draw = (time) => {
            ...
            // light trail fade
            ctx.fillStyle = 'rgba(244, 246, 252, 0.10)';
            ...
            for (let i = 0; i < drops.length; i++) {
                ...
                // bright leading glyph (violet), trail in indigo/blue
                ctx.fillStyle = Math.random() > 0.975 ? '#7c3aed' : 'rgba(79, 70, 229, 0.45)';
